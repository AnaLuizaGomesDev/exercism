...
def remove_suffix_ness(word):
    ...
    """
    word_separated = word.split('ness')
    if word_separated[0][-1] == 'i':
        return word_separated[0][0:-1] + 'y'
    return word_separated[0]
...
def adjective_to_verb(sentence, index):
    ...
    sentence_separated[index] = sentence_separated[index].strip(string.punctuation) + "en"
    return sentence_separated[index]
